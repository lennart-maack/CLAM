...
class Bottleneck_Baseline_ResNet18(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None):
        super(Bottleneck_Baseline_ResNet18, self).__init__()
...
def resnet_50_histo_pretr():
    """
    Constructs a ResNet-50 model and loads the weights from pretraining with histo imgs
    """
    model = ResNet_Baseline(Bottleneck_Baseline, [3, 4, 6, 3])
    model_weights_path = "/data/Maack/PANT/CLAM/experiments/resnet_50_histo_pretr/final_resnet50.pth"
